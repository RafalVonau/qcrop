...
QSettingsEditorFont::QSettingsEditorFont(QObject* parent, QObject* object, QString property, QObject *propertyModel): QSettingsEditorInterface(parent, object, property, propertyModel)
{
}
